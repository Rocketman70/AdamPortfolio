...
Since many Linux users primarily use the terminal or enjoy to use terminal
programs, it is worthwhile to create a Java implementation that can be used to
print and report directories to a "parent" program.
